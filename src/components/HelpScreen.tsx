...
export function HelpScreen({ version }: HelpScreenProps) {
  return (
    <Box flexDirection="column" padding={1}>
      ...
      {/* Usage */}
      <Section title="Usage">
        <Text><Text color={colors.accent}>ralph</Text> <Text dimColor>{"<command>"} [options]</Text></Text>
        <Text><Text color={colors.accent}>ralph</Text> <Text dimColor>{"<command>"}</Text> <Text color={colors.success}>--vibe</Text></Text>
      </Section>
      ...
      <Section title="Vibe Mode">
        ...
        <Box paddingLeft={2} flexDirection="column">
          <Text><Text dimColor>ralph init --vibe</Text>  <Text color={colors.dim}>→</Text> <Text color={colors.muted}>init → start → plan → work</Text></Text>
          <Text><Text dimColor>ralph spec --vibe</Text>  <Text color={colors.dim}>→</Text> <Text color={colors.muted}>spec → plan → work</Text></Text>
          <Text><Text dimColor>ralph plan --vibe</Text>  <Text color={colors.dim}>→</Text> <Text color={colors.muted}>plan → work</Text></Text>
        </Box>
      </Section>
      ...
      <Section title="Options">
        <Box flexDirection="row">
          <Box width={16}><Text color={colors.accent}>-h, --help</Text></Box>
          <Text color={colors.muted}>Show this help</Text>
        </Box>
        <Box flexDirection="row">
          <Box width={16}><Text color={colors.accent}>-v, --version</Text></Box>
