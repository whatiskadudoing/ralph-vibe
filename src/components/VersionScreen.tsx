...
import { Box, Text, Newline, render, useApp } from "../../packages/deno-ink/src/mod.ts";
...
function InfoRow({ label, value, valueColor = colors.muted }: InfoRowProps) {
  return (
...
export function CompactVersion({ version }: CompactVersionProps) {
  return (
